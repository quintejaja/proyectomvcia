...
namespace MVC_IA
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\talau\Desktop\TextFile1.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Categoria",inputColumnName:@"Categoria",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Categoria", sentence1ColumnName: @"Titulo"))      
